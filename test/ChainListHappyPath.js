...
contract('ChainList', function(accounts){
    ...
    var buyerBalanceBeforeBuy, buyBalanceAfterBuy;
    ...
    it("should buy an article", function(){
        return ChainList.deployed().then(function(instance){
            ...
            return chainListInstance.buyArticle({
                ...
                assert.equal(receipt.logs[0].event, "LogBuyArticle", "event shoulb be LogBuyArticle");
                ...
                // check th effect of buy on balances of and seller, accounting for gas
    ...
    it("should triger an event when a new article is sold", function(){
        return ChainList.deployed().then(function(instance) {
            chainListInstance = instance;
            return chainListInstance.sellArticle(articleName, articleDescription, web3.toWei(articlePrice, "ether"), {from: seller})
        }).then(function(receipt){
